    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // Lista de 10 tarjetas deslizables
          Container(
            height: 300,
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ElevatedButton(
                              onPressed: () {
                                print('Botón 1 presionado en tarjeta $index');
                              },
                            ...
                            ElevatedButton(
                              onPressed: () {
                                print('Botón 2 presionado en tarjeta $index');
                              },
                              style: ElevatedButton.styleFrom(
            ...
            child: FutureBuilder<List<NoteModel>>(
              ...
              builder: (BuildContext context,
                ...
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return const Center(child: Text("Add Service"));
          ...
          ElevatedButton(
            onPressed: () {
              // Cerrar sesión y navegar a LoginScreen
